...
class Simple_GF_Field extends GF_Field {
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		$input = "<input name='input_{$id}' id='date' type='text' value='{$value}' class='{$class}' {$tabindex} {$logic_event} {$placeholder_attribute} {$required_attribute} {$invalid_attribute} {$disabled_text}/>";
