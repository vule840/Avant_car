...
<div class="wrapper" id="wrapper-footer">
	...
	<div class="<?php echo esc_attr( $container ); ?>">
		...
		<div class="row">
			...
			<div class="col-md-4 text-md-left text-sm-center  py-3">
			...
			<div class="col-md-4 py-3 text-md-right text-sm-center"><img class="logo_avant" src="<?php bloginfo('url'); ?>/wp-content/uploads/2018/09/avant_car_logo.svg" alt="Karta Hrvatske"></div>
