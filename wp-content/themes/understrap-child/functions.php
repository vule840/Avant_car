...
function business_car() {
    ...
    $labels = array(
        'name'                  => _x( 'business_car', 'Post Type General Name', 'text_domain' ),
        'singular_name'         => _x( 'car', 'Post Type Singular Name', 'text_domain' ),
        'menu_name'             => __( 'business_car', 'text_domain' ),
        'name_admin_bar'        => __( 'Post Type', 'text_domain' ),
        'archives'              => __( 'Item Archives', 'text_domain' ),
        'attributes'            => __( 'Item Attributes', 'text_domain' ),
        'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
        'all_items'             => __( 'All Items', 'text_domain' ),
        'add_new_item'          => __( 'Dodaj novi auto', 'text_domain' ),
    ...
    $args = array(
        'label'                 => __( 'business_car', 'text_domain' ),
    ...
    register_post_type( 'business_car', $args );
